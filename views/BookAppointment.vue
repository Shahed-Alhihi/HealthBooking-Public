...
export default {
  ...
  mounted() {
    fetch("https://aot99r3n5c.execute-api.eu-north-1.amazonaws.com/prod/slots")
      .then(res => res.json())
      .then(data => {
        this.slots = data
          .filter(s => !s.isBooked)
  ...
  methods: {
    submitAppointment() {
      ...
      fetch("https://aot99r3n5c.execute-api.eu-north-1.amazonaws.com/prod/appointments", {
        method: "POST",
        headers: {
      ...
      body: JSON.stringify(payload)
        ...
        .then(() => {
          ...
          return fetch(
            "https://aot99r3n5c.execute-api.eu-north-1.amazonaws.com/prod/slots"
          );
        })
        .then(res => res.json())
        .then(data => {
